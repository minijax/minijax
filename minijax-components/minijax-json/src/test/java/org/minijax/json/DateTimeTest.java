...
class DateTimeTest {
    ...
    void testWriteZonedDateTime() throws IOException {
        assertEquals(
    ...
    @Test
    void testReadZonedDateTime() throws IOException {
        assertEquals(
    ...
    @Test
    void testWriteInstant() throws IOException {
        assertEquals(
    ...
    @Test
    void testReadInstant() throws IOException {
        assertEquals(
                ZonedDateTime.of(2017, 10, 31, 4, 38, 0, 0, PST).toInstant(),
