...
public class MinijaxOrm {
    private final String templateName;
    private final Map<String, Object> model;

    public MinijaxOrm(final String templateName) {
        this.templateName = templateName;
        model = new HashMap<>();
    }

    public MinijaxOrm(final String templateName, final String title) {
        this(templateName);
        model.put("title", title);
    }

    public MinijaxOrm(final String templateName, final Map<String, Object> model) {
        this(templateName);
