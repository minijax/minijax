...
public class RequestScopedTest {
    ...
    public void testRequestScoped() throws IOException {
        ...
        try (MinijaxRequestContext context = new MinijaxRequestContext(container, r1, null)) {
        ...
        try (MinijaxRequestContext context = new MinijaxRequestContext(container, r2, null)) {
